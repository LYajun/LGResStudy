...
typedef NS_ENUM(NSInteger , RLGPopupMenuType) {
    RLGPopupMenuTypeDefault = 0,
    RLGPopupMenuTypeDark
};

@class RLGPopupMenu;
@protocol RLGPopupMenuDelegate <NSObject>
...
// YJ新增
- (void)RLGPopupMenuDidDismiss;
@end


@interface RLGPopupMenu : UIView
...
/**
 设置显示模式 Default is RLGPopupMenuTypeDefault
 */
@property (nonatomic, assign) RLGPopupMenuType type;

/**
 代理
 */
@property (nonatomic, weak) id <RLGPopupMenuDelegate> delegate;
