...
typedef NS_ENUM(NSInteger,DicMeanType){
    DicMeanTypeSenCollection,
    DicMeanTypeColtCollection,
    DicMeanTypeClassicCollection,
    DicMeanTypeRltCollection,
    DicMeanTypeEnglishCollection
};
...
@interface DLGWordModel : NSObject
